...
def get_sim_dataloaders(partition_id: int, num_partitions: int, batch_size: int = 32):
    """Partition CIFAR-10 on the fly for the Simulation Engine."""
    ...
    partition = fds.load_partition(partition_id).train_test_split(
